<template>
  <section>
    <h1 class="m-2">Invoice</h1>
    <div class="invoice-container">
      <div class="board_invoice">
  ...
  methods: {
    ...
    async placeOrder() {
      try {
        ...
        const response = await axios.post(`https://colorful-dog-teddy.cyclic.app/orders/${userId}`, { orderItems });
        ...
        this.$router.push({ name: 'CardProduct' });
      } catch (error) {
